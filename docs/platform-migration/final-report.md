...
- `api-core`: pure cart/catalog/order operations, customer preferences and addresses, inventory operations and a provider-neutral checkout port; `apps/api` remains the D1/Stripe adapter.
