...
- `api-core`: pure cart/catalog/order operations, customer profile, preferences, addresses, customer-scoped order reads and reviews, inventory operations and a provider-neutral checkout port; `apps/api` remains the D1/Stripe adapter.
