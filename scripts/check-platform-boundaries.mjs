...
const policies = new Map([
  ...
  ["schemas", new Set()],
  ["storefront-default", new Set(["@aether/config-schema", "@aether/core", "@aether/schemas", "@aether/ui"])],
  ["admin-default", new Set(["@aether/config-schema", "@aether/schemas", "@aether/i18n"])],
