...
// Server-side availabilityStatus uses its own threshold for a different
// purpose (inventory classification). This threshold is only for whether
// the storefront shows the "low stock" chip, and is intentionally
// independent of that value.
