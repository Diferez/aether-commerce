...
export const adminDictionaries = {
  en: {
    ...
    orderDetailPage: {
      ...
      stripeRefundOnly: "Stripe orders can only change payment status through a real refund below.",
      refundViaStripe: "Refund via Stripe",
      refundViaStripeTitle: "Refund via Stripe?",
      refundDescription: "Refund the full amount ({amount}) via Stripe? This calls the real Stripe API and cannot be undone.",
    ...
    settingsPage: {
      ...
      freeShippingThresholdLabel: "Free shipping threshold in dollars",
  ...
  es: {
    ...
    orderDetailPage: {
      ...
      paymentSection: "Pago",
      stripeRefundOnly: "Los pedidos de Stripe solo pueden cambiar el estado de pago mediante un reembolso real abajo.",
      refundViaStripe: "Reembolsar vía Stripe",
      refundViaStripeTitle: "¿Reembolsar vía Stripe?",
      refundDescription: "¿Reembolsar el monto total ({amount}) vía Stripe? Esto llama a la API real de Stripe y no se puede deshacer.",
    ...
    settingsPage: {
      ...
      freeShippingThresholdLabel: "Umbral de envío gratis en dólares",
