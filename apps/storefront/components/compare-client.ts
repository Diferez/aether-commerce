...
// Local-only, same as favorites-client.ts and for the same reason: the real
// GET/POST/DELETE /compare routes (routes/user.ts) require a signed-in
...
// here rather than a dependency on api-core, which the storefront doesn't
// otherwise depend on.
